...
public class item_prefabs : MonoBehaviour
{
    public GameObject prefab_item; // 아이템
    private int numberOfItem = 30; //아이템 수
    ...
    void Start()
    {
        ...
        for (int i = 0; i < numberOfItem; i++)
        {
            ...
            GameObject go = Instantiate(prefab_item, pos, Quaternion.identity) as GameObject;
